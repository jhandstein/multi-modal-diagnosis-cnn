...
def construct_model_name(model: ConvBranch2d | FlexibleResNet, data_set: NakoSingleFeatureDataset, task: Literal["classifcation", "regression"], dim: Literal["2D", "3D"] = "2D") -> str:
    ...
    return f"{model_tag}_{dim}_{modality}_{feature_map}_{task}_{target}"
