...
def construct_model_name(model: BaseConvBranch2d | ResNet18Base2d, data_set: NakoSingleFeatureDataset) -> str:
    ...
    return f"{date_str}_{model_tag}_{modality}_{feature_map}_{target}"
